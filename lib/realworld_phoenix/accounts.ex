defmodule RealworldPhoenix.Accounts do
  @moduledoc """
  ...
  alias RealworldPhoenix.Accounts.{User, UserToken, UserNotifier}
  ...
  def register_user(attrs) do
    ...
    |> Ecto.Changeset.cast_assoc(
        :profile,
        with: &RealworldPhoenix.App.Profile.changeset/2
       )
    |> Repo.insert()
  end
  ...
  def change_user_settings(%User{} = user, attrs \\%{}) do
    ...
    |> Enum.reduce(changeset, fn field, changeset ->
        case Ecto.Changeset.fetch_change(changeset, field) do
          {:ok, nil} -> Ecto.Changeset.delete_change(changeset, field)
          _ -> changeset
        end
       end)
  end
